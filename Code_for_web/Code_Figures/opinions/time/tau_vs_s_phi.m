...
scatter(Svec-0.975,tau,100,clr,'LineWidth',2,'Marker',mrkrs(1));
loglog(Svec-1,0.6*(Svec-1).^-phi,'-','LineWidth',2,'Color',clr)
...
%% save
filename = ['figs/phi_tau_vs_s_',NetStruct,'_kappa',num2str(round(kappa)),'_N',num2str(N)];
saveas(gcf,filename)
