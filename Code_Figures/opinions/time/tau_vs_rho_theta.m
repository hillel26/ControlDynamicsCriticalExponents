...
loglog(rhoVec,0.53*rhoVec.^-theta,'-','LineWidth',2,'Color',clr)
...
%% save
filename = ['theta_tau_vs_rho_',NetStruct,'_kappa',num2str(round(kappa)),'_N',num2str(N)];
saveas(gcf,filename)
